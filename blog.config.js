...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'acedia', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Acedia-X', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.acediax.cn', // 网站地址
  ...
  // 欢迎语打字效果,Acedia,Hexo,Matery主题支持, 英文逗号隔开多个欢迎语。
  GREETING_WORDS:
